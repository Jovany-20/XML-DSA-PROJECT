...
bool encodeAndSave(const std::string& input, const std::string& fileName,std::string& resualtOFcompression ) {
    /*
    ...
    */
    ...
    // Save the encoded output to a string (optional step)
    std::string encodedMessage;
    for (int code : output_codes) {
        encodedMessage += std::to_string(code) + " ";
    }
    resualtOFcompression = encodedMessage;
    // You can use this string for further processing if needed
